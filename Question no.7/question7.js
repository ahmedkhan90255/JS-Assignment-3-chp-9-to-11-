document.write(
  "<h1> Guess game:<br> Store a secret number (ranging from 1 to 10) in a variable.<br> Prompt user to guess the secret number. <br> a. If user guesses the same number, show “Bingo! Correct answer”.<br> b. If the guessed number +1 is the secret number, show “Close enough to the correct answer”. </h1>"
);
